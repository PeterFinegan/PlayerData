...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2004&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_05 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_05$PlayerAppearences[ChelseaFirstTeam_05$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_05$PlayerAppearences <- as.numeric(ChelseaFirstTeam_05$PlayerAppearences)
...
write.csv(ChelseaFirstTeam_05, "C:/Users/peter/Desktop/PlayerData/04-05/FirstTeam_04-05.csv")

write.csv(rbind(ChelseaFirstTeam_05, ChelseaFirstTeam_05), "C:/Users/peter/Desktop/PlayerData/04-05/AllPlayers_04-05.csv")