...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2004&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_05 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_05$PlayerAppearences[ArsenalFirstTeam_05$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_05$PlayerAppearences <- as.numeric(ArsenalFirstTeam_05$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_05, "C:/Users/peter/Desktop/PlayerData/Arsenal/04-05/FirstTeam_04-05.csv")

write.csv(rbind(ArsenalFirstTeam_05, ArsenalU23_05), "C:/Users/peter/Desktop/PlayerData/Arsenal/04-05/AllPlayers_04-05.csv")