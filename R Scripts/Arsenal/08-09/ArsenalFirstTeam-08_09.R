...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2008&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_09 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_09$PlayerAppearences[ArsenalFirstTeam_09$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_09$PlayerAppearences <- as.numeric(ArsenalFirstTeam_09$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_09, "C:/Users/peter/Desktop/PlayerData/Arsenal/08-09/FirstTeam_08-09.csv")

write.csv(rbind(ArsenalFirstTeam_09, ArsenalU23_09), "C:/Users/peter/Desktop/PlayerData/Arsenal/08-09/AllPlayers_08-09.csv")