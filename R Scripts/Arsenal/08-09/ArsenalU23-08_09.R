...
page <- "https://www.transfermarkt.com/arsenal-fc-u23/leihspielerhistorie/verein/9249/saison_id/2008/leihe/ist/plus/1"
...
#assiging dataframe
ArsenalU23_09<- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalU23_09$PlayerAppearences[ArsenalU23_09$PlayerAppearences == "-"] <- "0"
ArsenalU23_09$PlayerAppearences <- as.numeric(ArsenalU23_09$PlayerAppearences)
#ChelseaU23_19$MarketValue[ChelseaU23_19$MarketValue == "-"] <- "0"
#ChelseaU23_19$MarketValue <- as.character(ChelseaU23_19$MarketValue)



write.csv(ArsenalU23_09, "C:/Users/peter/Desktop/PlayerData/Arsenal/08-09/ArsenalUnder23s_08-09.csv")

#save to csv
write.csv(rbind(ArsenalFirstTeam_09, ArsenalU23_09), "C:/Users/peter/Desktop/PlayerData/Arsenal/08-09/ArsenalAllPlayers_08-09.csv")