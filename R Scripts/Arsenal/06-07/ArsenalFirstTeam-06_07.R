...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2006&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_07 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_07$PlayerAppearences[ArsenalFirstTeam_07$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_07$PlayerAppearences <- as.numeric(ArsenalFirstTeam_07$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_07, "C:/Users/peter/Desktop/PlayerData/Arsenal/06-07/FirstTeam_06-07.csv")

write.csv(rbind(ArsenalFirstTeam_07, ArsenalU23_07), "C:/Users/peter/Desktop/PlayerData/Arsenal/06-07/AllPlayers_06-07.csv")