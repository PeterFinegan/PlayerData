...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2015&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_16 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_16$PlayerAppearences[ArsenalFirstTeam_16$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_16$PlayerAppearences <- as.numeric(ArsenalFirstTeam_16$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_16, "C:/Users/peter/Desktop/PlayerData/Arsenal/15-16/FirstTeam_15-16.csv")
