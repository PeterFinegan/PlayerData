...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2007&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_08 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_08$PlayerAppearences[ArsenalFirstTeam_08$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_08$PlayerAppearences <- as.numeric(ArsenalFirstTeam_08$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_08, "C:/Users/peter/Desktop/PlayerData/Arsenal/07-08/FirstTeam_07-08.csv")

write.csv(rbind(ArsenalFirstTeam_08, ArsenalU23_08), "C:/Users/peter/Desktop/PlayerData/Arsenal/07-08/AllPlayers_07-08.csv")