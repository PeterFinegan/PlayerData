...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2011&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_12 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_12$PlayerAppearences[ArsenalFirstTeam_12$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_12$PlayerAppearences <- as.numeric(ArsenalFirstTeam_12$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_12, "C:/Users/peter/Desktop/PlayerData/Arsenal/11-12/FirstTeam_11-12.csv")

write.csv(rbind(ArsenalFirstTeam_12, ArsenalU23_12), "C:/Users/peter/Desktop/PlayerData/Arsenal/11-12/AllPlayers_11-12.csv")
