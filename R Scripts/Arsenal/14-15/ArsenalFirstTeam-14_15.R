...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2014&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_15 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_15$PlayerAppearences[ArsenalFirstTeam_15$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_15$PlayerAppearences <- as.numeric(ArsenalFirstTeam_15$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_15, "C:/Users/peter/Desktop/PlayerData/Arsenal/14-15/FirstTeam_14-15.csv")

write.csv(rbind(ArsenalFirstTeam_15, ArsenalU23_15), "C:/Users/peter/Desktop/PlayerData/Arsenal/14-15/AllPlayers_14-15.csv")
