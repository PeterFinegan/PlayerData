...
page <- "https://www.transfermarkt.com/arsenal-fc-u23/leihspielerhistorie/verein/9249/saison_id/2014/leihe/ist/plus/1"
...
#assiging dataframe
ArsenalU23_15 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalU23_15$PlayerAppearences[ArsenalU23_15$PlayerAppearences == "-"] <- "0"
ArsenalU23_15$PlayerAppearences <- as.numeric(ArsenalU23_15$PlayerAppearences)
#ChelseaU23_19$MarketValue[ChelseaU23_19$MarketValue == "-"] <- "0"
#ChelseaU23_19$MarketValue <- as.character(ChelseaU23_19$MarketValue)



write.csv(ArsenalU23_15, "C:/Users/peter/Desktop/PlayerData/Arsenal/14-15/ArsenalUnder23s_14-15.csv")
