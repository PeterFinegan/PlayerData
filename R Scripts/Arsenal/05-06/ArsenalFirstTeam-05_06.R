...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2005&leihe=ist"
...
LoanClubCountry <- scraped_page %>%html_nodes(".inline-table .flaggenrahmen")
...
#assiging dataframe
ArsenalFirstTeam_06 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_06$PlayerAppearences[ArsenalFirstTeam_06$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_06$PlayerAppearences <- as.numeric(ArsenalFirstTeam_06$PlayerAppearences)
#ChelseaFirstTeam_19$MarketValue[ChelseaFirstTeam_19$MarketValue == "-"] <- "0"
#ChelseaFirstTeam_19$MarketValue <- as.character(ChelseaFirstTeam_19$MarketValue)

#save to csv
write.csv(ArsenalFirstTeam_06, "C:/Users/peter/Desktop/PlayerData/Arsenal/05-06/FirstTeam_05-06.csv")

write.csv(rbind(ArsenalFirstTeam_06, ArsenalU23_06), "C:/Users/peter/Desktop/PlayerData/Arsenal/05-06/AllPlayers_05-06.csv")