...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2009&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_10 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_10$PlayerAppearences[ArsenalFirstTeam_10$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_10$PlayerAppearences <- as.numeric(ArsenalFirstTeam_10$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_10, "C:/Users/peter/Desktop/PlayerData/Arsenal/09-10/FirstTeam_09-10.csv")

write.csv(rbind(ArsenalFirstTeam_10, ArsenalU23_10), "C:/Users/peter/Desktop/PlayerData/Arsenal/09-10/AllPlayers_09-10.csv")