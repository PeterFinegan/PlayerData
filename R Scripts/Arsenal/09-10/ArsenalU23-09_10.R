...
page <- "https://www.transfermarkt.com/arsenal-fc-u23/leihspielerhistorie/verein/9249/saison_id/2009/leihe/ist/plus/1"
...
#assiging dataframe
ArsenalU23_10<- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalU23_10$PlayerAppearences[ArsenalU23_10$PlayerAppearences == "-"] <- "0"
ArsenalU23_10$PlayerAppearences <- as.numeric(ArsenalU23_10$PlayerAppearences)
#ChelseaU23_19$MarketValue[ChelseaU23_19$MarketValue == "-"] <- "0"
#ChelseaU23_19$MarketValue <- as.character(ChelseaU23_19$MarketValue)



write.csv(ArsenalU23_10, "C:/Users/peter/Desktop/PlayerData/Arsenal/09-10/ArsenalUnder23s_09-10.csv")

#save to csv
write.csv(rbind(ArsenalFirstTeam_10, ArsenalU23_10), "C:/Users/peter/Desktop/PlayerData/Arsenal/09-10/ArsenalAllPlayers_09-10.csv")