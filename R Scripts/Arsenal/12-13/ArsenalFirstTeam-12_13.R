...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2012&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_13 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_13$PlayerAppearences[ArsenalFirstTeam_13$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_13$PlayerAppearences <- as.numeric(ArsenalFirstTeam_13$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_13, "C:/Users/peter/Desktop/PlayerData/Arsenal/12-13/FirstTeam_12-13.csv")

write.csv(rbind(ArsenalFirstTeam_13, ArsenalU23_13), "C:/Users/peter/Desktop/PlayerData/Arsenal/12-13/AllPlayers_12-13.csv")
