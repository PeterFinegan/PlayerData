...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2003&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_04 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_04$PlayerAppearences[ArsenalFirstTeam_04$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_04$PlayerAppearences <- as.numeric(ArsenalFirstTeam_04$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_04, "C:/Users/peter/Desktop/PlayerData/Arsenal/03-04/FirstTeam_03-04.csv")

write.csv(rbind(ArsenalFirstTeam_04), "C:/Users/peter/Desktop/PlayerData/Arsenal/03-04/AllPlayers_03-04.csv")