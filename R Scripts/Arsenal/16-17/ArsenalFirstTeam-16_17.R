...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2016&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_17 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_17$PlayerAppearences[ArsenalFirstTeam_17$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_17$PlayerAppearences <- as.numeric(ArsenalFirstTeam_17$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_17, "C:/Users/peter/Desktop/PlayerData/Arsenal/16-17/FirstTeam_16-17.csv")

write.csv(rbind(ArsenalFirstTeam_17, ArsenalU23_17), "C:/Users/peter/Desktop/PlayerData/Arsenal/16-17/AllPlayers_16-17.csv")
