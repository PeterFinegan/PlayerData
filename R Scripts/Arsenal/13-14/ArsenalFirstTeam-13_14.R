...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2013&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_14 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_14$PlayerAppearences[ArsenalFirstTeam_14$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_14$PlayerAppearences <- as.numeric(ArsenalFirstTeam_14$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_14, "C:/Users/peter/Desktop/PlayerData/Arsenal/13-14/FirstTeam_13-14.csv")

write.csv(rbind(ArsenalFirstTeam_14, ArsenalU23_14), "C:/Users/peter/Desktop/PlayerData/Arsenal/13-14/AllPlayers_13-14.csv")
