...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2010&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_11 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_11$PlayerAppearences[ArsenalFirstTeam_11$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_11$PlayerAppearences <- as.numeric(ArsenalFirstTeam_11$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_11, "C:/Users/peter/Desktop/PlayerData/Arsenal/10-11/FirstTeam_10-11.csv")

write.csv(rbind(ArsenalFirstTeam_11, ArsenalU23_11), "C:/Users/peter/Desktop/PlayerData/Arsenal/10-11/AllPlayers_10-11.csv")