...
page <- "https://www.transfermarkt.com/arsenal-fc-u23/leihspielerhistorie/verein/9249/saison_id/2010/leihe/ist/plus/1"
...
#assiging dataframe
ArsenalU23_11<- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalU23_11$PlayerAppearences[ArsenalU23_11$PlayerAppearences == "-"] <- "0"
ArsenalU23_11$PlayerAppearences <- as.numeric(ArsenalU23_11$PlayerAppearences)
#ChelseaU23_19$MarketValue[ChelseaU23_19$MarketValue == "-"] <- "0"
#ChelseaU23_19$MarketValue <- as.character(ChelseaU23_19$MarketValue)



write.csv(ArsenalU23_11, "C:/Users/peter/Desktop/PlayerData/Arsenal/10-11/ArsenalUnder23s_10-11.csv")

#save to csv
write.csv(rbind(ArsenalFirstTeam_11, ArsenalU23_11), "C:/Users/peter/Desktop/PlayerData/Arsenal/10-11/ArsenalAllPlayers_10-11.csv")