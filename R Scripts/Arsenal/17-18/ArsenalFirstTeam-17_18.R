...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2017&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_18 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_18$PlayerAppearences[ArsenalFirstTeam_18$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_18$PlayerAppearences <- as.numeric(ArsenalFirstTeam_18$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_18, "C:/Users/peter/Desktop/PlayerData/Arsenal/17-18/FirstTeam_17-18.csv")

write.csv(rbind(ArsenalFirstTeam_18, ArsenalU23_18), "C:/Users/peter/Desktop/PlayerData/Arsenal/17-18/AllPlayers_17-18.csv")