...
page <- "https://www.transfermarkt.com/arsenal-fc/leihspielerhistorie/verein/11/plus/1?saison_id=2018&leihe=ist"
...
#assiging dataframe
ArsenalFirstTeam_19 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ArsenalFirstTeam_19$PlayerAppearences[ArsenalFirstTeam_19$PlayerAppearences == "-"] <- "0"
ArsenalFirstTeam_19$PlayerAppearences <- as.numeric(ArsenalFirstTeam_19$PlayerAppearences)
...
#save to csv
write.csv(ArsenalFirstTeam_19, "C:/Users/peter/Desktop/PlayerData/Arsenal/18-19/FirstTeam_18-19.csv")

write.csv(rbind(ArsenalFirstTeam_19, ArsenalU23_19), "C:/Users/peter/Desktop/PlayerData/Arsenal/18-19/AllPlayers_18-19.csv")