...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2007/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_08 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_08$PlayerAppearences[ManUtdFirstTeam_08$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_08$PlayerAppearences <- as.numeric(ManUtdFirstTeam_08$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_08, "C:/Users/peter/Desktop/PlayerData/Manchester United/07-08/FirstTeam_07-08.csv")

write.csv(rbind(ManUtdFirstTeam_08, ManUtdU23_08), "C:/Users/peter/Desktop/PlayerData/Manchester United/07-08/AllPlayers_07-08.csv")