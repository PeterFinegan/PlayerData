...
page <- "https://www.transfermarkt.com/manchester-united-u23/leihspielerhistorie/verein/9251/saison_id/2007/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdU23_08 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdU23_08$PlayerAppearences[ManUtdU23_08$PlayerAppearences == "-"] <- "0"
ManUtdU23_08$PlayerAppearences <- as.numeric(ManUtdU23_08$PlayerAppearences)
...
write.csv(ManUtdU23_08, "C:/Users/peter/Desktop/PlayerData/Manchester United/07-08/U23_07-08.csv")
