...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2015/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_16 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_16$PlayerAppearences[ManUtdFirstTeam_16$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_16$PlayerAppearences <- as.numeric(ManUtdFirstTeam_16$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_16, "C:/Users/peter/Desktop/PlayerData/Manchester United/15-16/FirstTeam_15-16.csv")

write.csv(rbind(ManUtdFirstTeam_16, ManUtdU23_16), "C:/Users/peter/Desktop/PlayerData/Manchester United/15-16/AllPlayers_15-16.csv")