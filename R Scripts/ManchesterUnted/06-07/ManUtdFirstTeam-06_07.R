...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2006/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_07 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_07$PlayerAppearences[ManUtdFirstTeam_07$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_07$PlayerAppearences <- as.numeric(ManUtdFirstTeam_07$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_07, "C:/Users/peter/Desktop/PlayerData/Manchester United/06-07/FirstTeam_06-07.csv")

write.csv(rbind(ManUtdFirstTeam_07, ManUtdU23_07), "C:/Users/peter/Desktop/PlayerData/Manchester United/06-07/AllPlayers_06-07.csv")