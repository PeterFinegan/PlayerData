...
page <- "https://www.transfermarkt.com/manchester-united-u23/leihspielerhistorie/verein/9251/saison_id/2006/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdU23_07 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdU23_07$PlayerAppearences[ManUtdU23_07$PlayerAppearences == "-"] <- "0"
ManUtdU23_07$PlayerAppearences <- as.numeric(ManUtdU23_07$PlayerAppearences)
...
write.csv(ManUtdU23_07, "C:/Users/peter/Desktop/PlayerData/Manchester United/06-07/U23_06-07.csv")
