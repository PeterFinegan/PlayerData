...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2008/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_09 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_09$PlayerAppearences[ManUtdFirstTeam_09$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_09$PlayerAppearences <- as.numeric(ManUtdFirstTeam_09$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_09, "C:/Users/peter/Desktop/PlayerData/Manchester United/08-09/FirstTeam_08-09.csv")
