...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2004/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_05 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_05$PlayerAppearences[ManUtdFirstTeam_05$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_05$PlayerAppearences <- as.numeric(ManUtdFirstTeam_05$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_05, "C:/Users/peter/Desktop/PlayerData/Manchester United/04-05/FirstTeam_04-05.csv")

write.csv(rbind(ManUtdFirstTeam_05, ManUtdU23_05), "C:/Users/peter/Desktop/PlayerData/Manchester United/04-05/AllPlayers_04-05.csv")