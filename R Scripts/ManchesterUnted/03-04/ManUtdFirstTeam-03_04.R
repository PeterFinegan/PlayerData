...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2003/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_04 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_04$PlayerAppearences[ManUtdFirstTeam_04$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_04$PlayerAppearences <- as.numeric(ManUtdFirstTeam_04$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_04, "C:/Users/peter/Desktop/PlayerData/Manchester United/03-04/FirstTeam_03-04.csv")

write.csv(rbind(ManUtdFirstTeam_04, ManUtdU23_04), "C:/Users/peter/Desktop/PlayerData/Manchester United/03-04/AllPlayers_03-04.csv")