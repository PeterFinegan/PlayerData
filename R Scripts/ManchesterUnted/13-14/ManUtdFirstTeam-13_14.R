...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2013/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_14 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_14$PlayerAppearences[ManUtdFirstTeam_14$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_14$PlayerAppearences <- as.numeric(ManUtdFirstTeam_14$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_14, "C:/Users/peter/Desktop/PlayerData/Manchester United/13-14/FirstTeam_13-14.csv")

write.csv(rbind(ManUtdFirstTeam_14, ManUtdU23_14), "C:/Users/peter/Desktop/PlayerData/Manchester United/13-14/AllPlayers_13-14.csv")