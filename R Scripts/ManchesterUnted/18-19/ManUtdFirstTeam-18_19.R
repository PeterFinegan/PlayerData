...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2018/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_19 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_19$PlayerAppearences[ManUtdFirstTeam_19$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_19$PlayerAppearences <- as.numeric(ManUtdFirstTeam_19$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_19, "C:/Users/peter/Desktop/PlayerData/Manchester United/18-19/FirstTeam_18-19.csv")

write.csv(rbind(ManUtdFirstTeam_19, ManUtdU23_19), "C:/Users/peter/Desktop/PlayerData/Manchester United/18-19/AllPlayers_18-19.csv")