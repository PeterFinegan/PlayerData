...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2014/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_15 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_15$PlayerAppearences[ManUtdFirstTeam_15$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_15$PlayerAppearences <- as.numeric(ManUtdFirstTeam_15$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_15, "C:/Users/peter/Desktop/PlayerData/Manchester United/14-15/FirstTeam_14-15.csv")

write.csv(rbind(ManUtdFirstTeam_15, ManUtdU23_15), "C:/Users/peter/Desktop/PlayerData/Manchester United/14-15/AllPlayers_14-15.csv")