...
page <- "https://www.transfermarkt.com/manchester-united-u23/leihspielerhistorie/verein/9251/saison_id/2012/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdU23_13 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdU23_13$PlayerAppearences[ManUtdU23_13$PlayerAppearences == "-"] <- "0"
ManUtdU23_13$PlayerAppearences <- as.numeric(ManUtdU23_13$PlayerAppearences)
...
write.csv(ManUtdU23_13, "C:/Users/peter/Desktop/PlayerData/Manchester United/12-13/U23_13-14.csv")
