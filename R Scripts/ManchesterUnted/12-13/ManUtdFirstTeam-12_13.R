...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2012/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_13 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_13$PlayerAppearences[ManUtdFirstTeam_13$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_13$PlayerAppearences <- as.numeric(ManUtdFirstTeam_13$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_13, "C:/Users/peter/Desktop/PlayerData/Manchester United/12-13/FirstTeam_12-13.csv")

write.csv(rbind(ManUtdFirstTeam_13, ManUtdU23_13), "C:/Users/peter/Desktop/PlayerData/Manchester United/12-13/AllPlayers_12-13.csv")