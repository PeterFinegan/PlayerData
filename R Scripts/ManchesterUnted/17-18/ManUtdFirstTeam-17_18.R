...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2017/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_18 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_18$PlayerAppearences[ManUtdFirstTeam_18$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_18$PlayerAppearences <- as.numeric(ManUtdFirstTeam_18$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_18, "C:/Users/peter/Desktop/PlayerData/Manchester United/17-18/FirstTeam_17-18.csv")

write.csv(rbind(ManUtdFirstTeam_18, ManUtdU23_18), "C:/Users/peter/Desktop/PlayerData/Manchester United/17-18/AllPlayers_17-18.csv")