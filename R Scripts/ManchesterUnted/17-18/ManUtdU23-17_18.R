...
page <- "https://www.transfermarkt.com/manchester-united-u23/leihspielerhistorie/verein/9251/saison_id/2017/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdU23_18 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdU23_18$PlayerAppearences[ManUtdU23_18$PlayerAppearences == "-"] <- "0"
ManUtdU23_18$PlayerAppearences <- as.numeric(ManUtdU23_18$PlayerAppearences)
...
write.csv(ManUtdU23_18, "C:/Users/peter/Desktop/PlayerData/Manchester United/17-18/U23_17-18.csv")
