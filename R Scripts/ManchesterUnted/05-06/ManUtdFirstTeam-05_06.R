...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2005/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_06 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_06$PlayerAppearences[ManUtdFirstTeam_06$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_06$PlayerAppearences <- as.numeric(ManUtdFirstTeam_06$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_06, "C:/Users/peter/Desktop/PlayerData/Manchester United/05-06/FirstTeam_05-06.csv")

write.csv(rbind(ManUtdFirstTeam_06, ManUtdU23_06), "C:/Users/peter/Desktop/PlayerData/Manchester United/05-06/AllPlayers_05-06.csv")