...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2010/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_11 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_11$PlayerAppearences[ManUtdFirstTeam_11$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_11$PlayerAppearences <- as.numeric(ManUtdFirstTeam_11$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_11, "C:/Users/peter/Desktop/PlayerData/Manchester United/10-11/FirstTeam_10-11.csv")

write.csv(rbind(ManUtdFirstTeam_11, ManUtdU23_11), "C:/Users/peter/Desktop/PlayerData/Manchester United/10-11/AllPlayers_10-11.csv")