...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2016/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_17 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_17$PlayerAppearences[ManUtdFirstTeam_17$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_17$PlayerAppearences <- as.numeric(ManUtdFirstTeam_17$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_17, "C:/Users/peter/Desktop/PlayerData/Manchester United/16-17/FirstTeam_16-17.csv")

write.csv(rbind(ManUtdFirstTeam_17, ManUtdU23_17), "C:/Users/peter/Desktop/PlayerData/Manchester United/16-17/AllPlayers_16-17.csv")