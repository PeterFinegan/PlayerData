...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2009/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_10 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_10$PlayerAppearences[ManUtdFirstTeam_10$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_10$PlayerAppearences <- as.numeric(ManUtdFirstTeam_10$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_10, "C:/Users/peter/Desktop/PlayerData/Manchester United/09-10/FirstTeam_09-10.csv")

write.csv(rbind(ManUtdFirstTeam_10, ManUtdU23_10), "C:/Users/peter/Desktop/PlayerData/Manchester United/09-10/AllPlayers_09-10.csv")