...
page <- "https://www.transfermarkt.com/manchester-united-u23/leihspielerhistorie/verein/9251/saison_id/2009/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdU23_10 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdU23_10$PlayerAppearences[ManUtdU23_10$PlayerAppearences == "-"] <- "0"
ManUtdU23_10$PlayerAppearences <- as.numeric(ManUtdU23_10$PlayerAppearences)
...
write.csv(ManUtdU23_10, "C:/Users/peter/Desktop/PlayerData/Manchester United/09-10/U23_09-10.csv")
