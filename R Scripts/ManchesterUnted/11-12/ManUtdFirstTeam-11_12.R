...
page <- "https://www.transfermarkt.com/manchester-united/leihspielerhistorie/verein/985/saison_id/2011/leihe/ist/plus/1"
...
#assiging dataframe
ManUtdFirstTeam_12 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManUtdFirstTeam_12$PlayerAppearences[ManUtdFirstTeam_12$PlayerAppearences == "-"] <- "0"
ManUtdFirstTeam_12$PlayerAppearences <- as.numeric(ManUtdFirstTeam_12$PlayerAppearences)
...
write.csv(ManUtdFirstTeam_12, "C:/Users/peter/Desktop/PlayerData/Manchester United/11-12/FirstTeam_11-12.csv")

write.csv(rbind(ManUtdFirstTeam_12, ManUtdU23_12), "C:/Users/peter/Desktop/PlayerData/Manchester United/11-12/AllPlayers_11-12.csv")