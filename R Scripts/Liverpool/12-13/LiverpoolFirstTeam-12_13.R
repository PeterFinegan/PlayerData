...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2012&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_13 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_13$PlayerAppearences[LiverpoolFirstTeam_13$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_13$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_13$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_13, "C:/Users/peter/Desktop/PlayerData/Liverpool/12-13/FirstTeam_12-13.csv")

write.csv(rbind(LiverpoolFirstTeam_13, LiverpoolU23_13), "C:/Users/peter/Desktop/PlayerData/Liverpool/12-13/AllPlayers_12-13.csv")