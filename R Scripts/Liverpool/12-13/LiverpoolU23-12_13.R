...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2012&leihe=ist"
...
#assiging dataframe
LiverpoolU23_13 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_13$PlayerAppearences[LiverpoolU23_13$PlayerAppearences == "-"] <- "0"
LiverpoolU23_13$PlayerAppearences <- as.numeric(LiverpoolU23_13$PlayerAppearences)
...
write.csv(LiverpoolU23_13, "C:/Users/peter/Desktop/PlayerData/Liverpool/12-13/U23_12-13.csv")
