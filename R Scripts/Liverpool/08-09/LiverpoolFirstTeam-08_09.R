...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2008&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_09 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_09$PlayerAppearences[LiverpoolFirstTeam_09$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_09$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_09$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_09, "C:/Users/peter/Desktop/PlayerData/Liverpool/08-09/FirstTeam_08-09.csv")

write.csv(rbind(LiverpoolFirstTeam_09, LiverpoolU23_09), "C:/Users/peter/Desktop/PlayerData/Liverpool/08-09/AllPlayers_08-09.csv")