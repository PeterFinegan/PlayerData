...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2008&leihe=ist"
...
#assiging dataframe
LiverpoolU23_09 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_09$PlayerAppearences[LiverpoolU23_09$PlayerAppearences == "-"] <- "0"
LiverpoolU23_09$PlayerAppearences <- as.numeric(LiverpoolU23_09$PlayerAppearences)
...
write.csv(LiverpoolU23_09, "C:/Users/peter/Desktop/PlayerData/Liverpool/08-09/U23_08-09.csv")
