...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2009&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_10 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_10$PlayerAppearences[LiverpoolFirstTeam_10$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_10$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_10$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_10, "C:/Users/peter/Desktop/PlayerData/Liverpool/09-10/FirstTeam_09-10.csv")
