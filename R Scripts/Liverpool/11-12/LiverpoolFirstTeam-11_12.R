...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2011&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_12 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_12$PlayerAppearences[LiverpoolFirstTeam_12$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_12$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_12$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_12, "C:/Users/peter/Desktop/PlayerData/Liverpool/11-12/FirstTeam_11-12.csv")

write.csv(rbind(LiverpoolFirstTeam_12, LiverpoolU23_12), "C:/Users/peter/Desktop/PlayerData/Liverpool/11-12/AllPlayers_11-12.csv")