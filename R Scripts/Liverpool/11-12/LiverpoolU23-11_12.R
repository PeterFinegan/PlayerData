...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2011&leihe=ist"
...
#assiging dataframe
LiverpoolU23_12 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_12$PlayerAppearences[LiverpoolU23_12$PlayerAppearences == "-"] <- "0"
LiverpoolU23_12$PlayerAppearences <- as.numeric(LiverpoolU23_12$PlayerAppearences)
...
write.csv(LiverpoolU23_12, "C:/Users/peter/Desktop/PlayerData/Liverpool/11-12/U23_11-12.csv")
