...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2010&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_11 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_11$PlayerAppearences[LiverpoolFirstTeam_11$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_11$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_11$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_11, "C:/Users/peter/Desktop/PlayerData/Liverpool/10-11/FirstTeam_10-11.csv")

write.csv(rbind(LiverpoolFirstTeam_11, LiverpoolU23_11), "C:/Users/peter/Desktop/PlayerData/Liverpool/10-11/AllPlayers_10-11.csv")