...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2010&leihe=ist"
...
#assiging dataframe
LiverpoolU23_11 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_11$PlayerAppearences[LiverpoolU23_11$PlayerAppearences == "-"] <- "0"
LiverpoolU23_11$PlayerAppearences <- as.numeric(LiverpoolU23_11$PlayerAppearences)
...
write.csv(LiverpoolU23_11, "C:/Users/peter/Desktop/PlayerData/Liverpool/10-11/U23_10-11.csv")
