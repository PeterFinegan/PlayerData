...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2007&leihe=ist"
...
#assiging dataframe
LiverpoolU23_08 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_08$PlayerAppearences[LiverpoolU23_08$PlayerAppearences == "-"] <- "0"
LiverpoolU23_08$PlayerAppearences <- as.numeric(LiverpoolU23_08$PlayerAppearences)
...
write.csv(LiverpoolU23_08, "C:/Users/peter/Desktop/PlayerData/Liverpool/07-08/U23_07-08.csv")
