...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2007&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_08 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_08$PlayerAppearences[LiverpoolFirstTeam_08$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_08$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_08$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_08, "C:/Users/peter/Desktop/PlayerData/Liverpool/07-08/FirstTeam_07-08.csv")

write.csv(rbind(LiverpoolFirstTeam_08, LiverpoolU23_08), "C:/Users/peter/Desktop/PlayerData/Liverpool/07-08/AllPlayers_07-08.csv")