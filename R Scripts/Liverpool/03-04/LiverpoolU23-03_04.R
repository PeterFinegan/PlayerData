...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2003&leihe=ist"
...
#assiging dataframe
LiverpoolU23_04 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_04$PlayerAppearences[LiverpoolU23_04$PlayerAppearences == "-"] <- "0"
LiverpoolU23_04$PlayerAppearences <- as.numeric(LiverpoolU23_04$PlayerAppearences)
...
write.csv(LiverpoolU23_04, "C:/Users/peter/Desktop/PlayerData/Liverpool/03-04/U23_03-04.csv")

write.csv(rbind(LiverpoolFirstTeam_04, LiverpoolU23_04), "C:/Users/peter/Desktop/PlayerData/Liverpool/03-04/AllPlayers_03-04.csv")