...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2003&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_04 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_04$PlayerAppearences[LiverpoolFirstTeam_04$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_04$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_04$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_04, "C:/Users/peter/Desktop/PlayerData/Liverpool/03-04/FirstTeam_03-04.csv")

write.csv(rbind(LiverpoolFirstTeam_04), "C:/Users/peter/Desktop/PlayerData/Liverpool/03-04/AllPlayers_03-04.csv")