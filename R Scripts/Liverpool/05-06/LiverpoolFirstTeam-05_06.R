...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2005&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_06 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_06$PlayerAppearences[LiverpoolFirstTeam_06$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_06$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_06$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_06, "C:/Users/peter/Desktop/PlayerData/Liverpool/05-06/FirstTeam_05-06.csv")

write.csv(rbind(LiverpoolFirstTeam_06, LiverpoolU23_06), "C:/Users/peter/Desktop/PlayerData/Liverpool/05-06/AllPlayers_05-06.csv")