...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2005&leihe=ist"
...
#assiging dataframe
LiverpoolU23_06 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_06$PlayerAppearences[LiverpoolU23_06$PlayerAppearences == "-"] <- "0"
LiverpoolU23_06$PlayerAppearences <- as.numeric(LiverpoolU23_06$PlayerAppearences)
...
write.csv(LiverpoolU23_06, "C:/Users/peter/Desktop/PlayerData/Liverpool/05-06/U23_05-06.csv")
