...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2013&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_14 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_14$PlayerAppearences[LiverpoolFirstTeam_14$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_14$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_14$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_14, "C:/Users/peter/Desktop/PlayerData/Liverpool/13-14/FirstTeam_13-14.csv")

write.csv(rbind(LiverpoolFirstTeam_14, LiverpoolU23_14), "C:/Users/peter/Desktop/PlayerData/Liverpool/13-14/AllPlayers_13-14.csv")