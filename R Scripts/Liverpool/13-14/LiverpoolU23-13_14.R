...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2013&leihe=ist"
...
#assiging dataframe
LiverpoolU23_14 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_14$PlayerAppearences[LiverpoolU23_14$PlayerAppearences == "-"] <- "0"
LiverpoolU23_14$PlayerAppearences <- as.numeric(LiverpoolU23_14$PlayerAppearences)
...
write.csv(LiverpoolU23_14, "C:/Users/peter/Desktop/PlayerData/Liverpool/13-14/U23_13-14.csv")
