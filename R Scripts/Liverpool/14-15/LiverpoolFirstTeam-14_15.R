...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2014&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_15 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_15$PlayerAppearences[LiverpoolFirstTeam_15$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_15$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_15$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_15, "C:/Users/peter/Desktop/PlayerData/Liverpool/14-15/FirstTeam_14-15.csv")

write.csv(rbind(LiverpoolFirstTeam_15, LiverpoolU23_15), "C:/Users/peter/Desktop/PlayerData/Liverpool/14-15/AllPlayers_14-15.csv")