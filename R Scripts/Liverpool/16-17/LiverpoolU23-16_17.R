...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2016&leihe=ist"
...
#assiging dataframe
LiverpoolU23_17 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_17$PlayerAppearences[LiverpoolU23_17$PlayerAppearences == "-"] <- "0"
LiverpoolU23_17$PlayerAppearences <- as.numeric(LiverpoolU23_17$PlayerAppearences)
...
write.csv(LiverpoolU23_17, "C:/Users/peter/Desktop/PlayerData/Liverpool/16-17/U23_16-17.csv")
