...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2016&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_17 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_17$PlayerAppearences[LiverpoolFirstTeam_17$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_17$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_17$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_17, "C:/Users/peter/Desktop/PlayerData/Liverpool/16-17/FirstTeam_16-17.csv")

write.csv(rbind(LiverpoolFirstTeam_17, LiverpoolU23_17), "C:/Users/peter/Desktop/PlayerData/Liverpool/16-17/AllPlayers_16-17.csv")