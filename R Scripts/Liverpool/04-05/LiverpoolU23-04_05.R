...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2004&leihe=ist"
...
#assiging dataframe
LiverpoolU23_05 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_05$PlayerAppearences[LiverpoolU23_05$PlayerAppearences == "-"] <- "0"
LiverpoolU23_05$PlayerAppearences <- as.numeric(LiverpoolU23_05$PlayerAppearences)
...
write.csv(LiverpoolU23_05, "C:/Users/peter/Desktop/PlayerData/Liverpool/04-05/U23_04-05.csv")

write.csv(rbind(LiverpoolFirstTeam_05, LiverpoolU23_05), "C:/Users/peter/Desktop/PlayerData/Liverpool/04-05/AllPlayers_04-05.csv")