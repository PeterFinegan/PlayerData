...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2004&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_05 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_05$PlayerAppearences[LiverpoolFirstTeam_05$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_05$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_05$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_05, "C:/Users/peter/Desktop/PlayerData/Liverpool/04-05/FirstTeam_04-05.csv")

write.csv(rbind(LiverpoolFirstTeam_05), "C:/Users/peter/Desktop/PlayerData/Liverpool/04-05/AllPlayers_04-05.csv")