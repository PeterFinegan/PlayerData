...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2018&leihe=ist"
...
#assiging dataframe
LiverpoolU23_19 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_19$PlayerAppearences[LiverpoolU23_19$PlayerAppearences == "-"] <- "0"
LiverpoolU23_19$PlayerAppearences <- as.numeric(LiverpoolU23_19$PlayerAppearences)
...
write.csv(LiverpoolU23_19, "C:/Users/peter/Desktop/PlayerData/Liverpool/18-19/U23_18-19.csv")
