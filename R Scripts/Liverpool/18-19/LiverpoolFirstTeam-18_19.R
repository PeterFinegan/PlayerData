...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2018&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_19 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_19$PlayerAppearences[LiverpoolFirstTeam_19$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_19$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_19$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_19, "C:/Users/peter/Desktop/PlayerData/Liverpool/18-19/FirstTeam_18-19.csv")

write.csv(rbind(LiverpoolFirstTeam_19, LiverpoolU23_19), "C:/Users/peter/Desktop/PlayerData/Liverpool/18-19/AllPlayers_18-19.csv")