...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2017&leihe=ist"
...
#assiging dataframe
LiverpoolU23_18 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_18$PlayerAppearences[LiverpoolU23_18$PlayerAppearences == "-"] <- "0"
LiverpoolU23_18$PlayerAppearences <- as.numeric(LiverpoolU23_18$PlayerAppearences)
...
write.csv(LiverpoolU23_18, "C:/Users/peter/Desktop/PlayerData/Liverpool/17-18/U23_17-18.csv")
