...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2017&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_18 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_18$PlayerAppearences[LiverpoolFirstTeam_18$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_18$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_18$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_18, "C:/Users/peter/Desktop/PlayerData/Liverpool/17-18/FirstTeam_17-18.csv")

write.csv(rbind(LiverpoolFirstTeam_18, LiverpoolU23_18), "C:/Users/peter/Desktop/PlayerData/Liverpool/17-18/AllPlayers_17-18.csv")