...
page <- "https://www.transfermarkt.com/liverpool-fc/leihspielerhistorie/verein/31/plus/1?saison_id=2015&leihe=ist"
...
#assiging dataframe
LiverpoolFirstTeam_16 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolFirstTeam_16$PlayerAppearences[LiverpoolFirstTeam_16$PlayerAppearences == "-"] <- "0"
LiverpoolFirstTeam_16$PlayerAppearences <- as.numeric(LiverpoolFirstTeam_16$PlayerAppearences)
...
write.csv(LiverpoolFirstTeam_16, "C:/Users/peter/Desktop/PlayerData/Liverpool/15-16/FirstTeam_15-16.csv")

write.csv(rbind(LiverpoolFirstTeam_16, LiverpoolU23_16), "C:/Users/peter/Desktop/PlayerData/Liverpool/15-16/AllPlayers_15-16.csv")