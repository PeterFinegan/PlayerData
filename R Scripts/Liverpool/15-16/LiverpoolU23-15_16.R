...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2015&leihe=ist"
...
#assiging dataframe
LiverpoolU23_16 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_16$PlayerAppearences[LiverpoolU23_16$PlayerAppearences == "-"] <- "0"
LiverpoolU23_16$PlayerAppearences <- as.numeric(LiverpoolU23_16$PlayerAppearences)
...
write.csv(LiverpoolU23_16, "C:/Users/peter/Desktop/PlayerData/Liverpool/15-16/U23_15-16.csv")
