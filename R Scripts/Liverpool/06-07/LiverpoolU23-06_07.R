...
page <- "https://www.transfermarkt.com/liverpool-fc-u23/leihspielerhistorie/verein/9252/plus/1?saison_id=2006&leihe=ist"
...
#assiging dataframe
LiverpoolU23_07 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
LiverpoolU23_07$PlayerAppearences[LiverpoolU23_07$PlayerAppearences == "-"] <- "0"
LiverpoolU23_07$PlayerAppearences <- as.numeric(LiverpoolU23_07$PlayerAppearences)
...
write.csv(LiverpoolU23_07, "C:/Users/peter/Desktop/PlayerData/Liverpool/06-07/U23_06-07.csv")

write.csv(rbind(LiverpoolFirstTeam_06, LiverpoolU23_06), "C:/Users/peter/Desktop/PlayerData/Liverpool/06-07/AllPlayers_06-07.csv")