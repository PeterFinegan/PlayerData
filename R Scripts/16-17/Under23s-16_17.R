...
#assiging dataframe
ChelseaU23_17 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaU23_17$PlayerAppearences[ChelseaU23_17$PlayerAppearences == "-"] <- "0"
ChelseaU23_17$PlayerAppearences <- as.numeric(ChelseaU23_17$PlayerAppearences)
ChelseaU23_17$MarketValue[ChelseaU23_17$MarketValue == "-"] <- "0"
ChelseaU23_17$MarketValue <- as.character(ChelseaU23_17$MarketValue)

#save to csv

write.csv(ChelseaU23_17, "C:/Users/peter/Desktop/PlayerData/16-17/Under23s_16-17.csv")


write.csv(rbind(ChelseaU23_17), "C:/Users/peter/Desktop/PlayerData/16-17/AllPlayers_16-17.csv")