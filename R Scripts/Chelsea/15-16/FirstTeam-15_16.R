...
#assiging dataframe
ChelseaFirstTeam_16 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)
...
write.csv(ChelseaFirstTeam_16, "C:/Users/peter/Desktop/PlayerData/Chelsea/15-16/FirstTeam_15-16.csv")

write.csv(rbind(ChelseaFirstTeam_16, ChelseaU23_16), "C:/Users/peter/Desktop/PlayerData/Chelsea/15-16/AllPlayers_15-16.csv")