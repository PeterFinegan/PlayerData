...
#assiging dataframe
ChelseaU23_16 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)
...
write.csv(ChelseaU23_16, "C:/Users/peter/Desktop/PlayerData/Chelsea/15-16/Under23s_15-16.csv")
