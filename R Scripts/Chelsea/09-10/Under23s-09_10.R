...
page <- "https://www.transfermarkt.com/chelsea-fc-u23/leihspielerhistorie/verein/9250/plus/1?saison_id=2009&leihe=ist"
...
#assiging dataframe
ChelseaU23_10 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaU23_10$PlayerAppearences[ChelseaU23_10$PlayerAppearences == "-"] <- "0"
ChelseaU23_10$PlayerAppearences <- as.numeric(ChelseaU23_10$PlayerAppearences)
...
write.csv(ChelseaU23_10, "C:/Users/peter/Desktop/PlayerData/Chelsea/09-10/Under23s_09-10.csv")

write.csv(rbind(ChelseaU23_10, ChelseaFirstTeam_10), "C:/Users/peter/Desktop/PlayerData/Chelsea/09-10/AllPlayers_09-10.csv")