...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2009&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_10 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_10$PlayerAppearences[ChelseaFirstTeam_10$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_10$PlayerAppearences <- as.numeric(ChelseaFirstTeam_10$PlayerAppearences)
...
write.csv(ChelseaFirstTeam_10, "C:/Users/peter/Desktop/PlayerData/Chelsea/09-10/FirstTeam_09-10.csv")

write.csv(rbind(ChelseaFirstTeam_10), "C:/Users/peter/Desktop/PlayerData/Chelsea/09-10/AllPlayers_09-10.csv")