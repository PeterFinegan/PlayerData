...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2010&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_11 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_11$PlayerAppearences[ChelseaFirstTeam_11$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_11$PlayerAppearences <- as.numeric(ChelseaFirstTeam_11$PlayerAppearences)
ChelseaFirstTeam_11$MarketValue[ChelseaFirstTeam_11$MarketValue == "-"] <- "0"
ChelseaFirstTeam_11$MarketValue <- as.character(ChelseaFirstTeam_11$MarketValue)

#save to csv

write.csv(ChelseaFirstTeam_11, "C:/Users/peter/Desktop/PlayerData/Chelsea/10-11/FirstTeam_10-11.csv")


write.csv(rbind(ChelseaFirstTeam_11, ChelseaU23_11), "C:/Users/peter/Desktop/PlayerData/Chelsea/10-11/AllPlayers_10-11.csv")