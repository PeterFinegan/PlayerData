...
page <- "https://www.transfermarkt.com/chelsea-fc-u23/leihspielerhistorie/verein/9250/plus/1?saison_id=2010&leihe=ist"
...
#assiging dataframe
ChelseaU23_11 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaU23_11$PlayerAppearences[ChelseaU23_11$PlayerAppearences == "-"] <- "0"
ChelseaU23_11$PlayerAppearences <- as.numeric(ChelseaU23_11$PlayerAppearences)
...
write.csv(ChelseaU23_11, "C:/Users/peter/Desktop/PlayerData/Chelsea/10-11/Under23s_10-11.csv")


write.csv(rbind(ChelseaU23_11, ChelseaFirstTeam_11), "C:/Users/peter/Desktop/PlayerData/Chelsea/10-11/AllPlayers_10-11.csv")