...
#assiging dataframe
ChelseaFirstTeam_15 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)
...
write.csv(ChelseaFirstTeam_15, "C:/Users/peter/Desktop/PlayerData/Chelsea/14-15/FirstTeam_14-15.csv")

write.csv(rbind(ChelseaFirstTeam_15, ChelseaU23_15), "C:/Users/peter/Desktop/PlayerData/Chelsea/14-15/AllPlayers_14-15.csv")