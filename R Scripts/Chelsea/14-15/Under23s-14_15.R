...
#assiging dataframe
ChelseaU23_15 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)
...
write.csv(ChelseaU23_15, "C:/Users/peter/Desktop/PlayerData/Chelsea/14-15/Under23s_14-15.csv")
