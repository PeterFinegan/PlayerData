...
page <- "https://www.transfermarkt.com/chelsea-fc-u23/leihspielerhistorie/verein/9250/plus/1?saison_id=2008&leihe=ist"
...
#assiging dataframe
ChelseaU23_09 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaU23_09$PlayerAppearences[ChelseaU23_09$PlayerAppearences == "-"] <- "0"
ChelseaU23_09$PlayerAppearences <- as.numeric(ChelseaU23_09$PlayerAppearences)
...
write.csv(ChelseaU23_09, "C:/Users/peter/Desktop/PlayerData/Chelsea/08-09/Under23s_08-09.csv")

write.csv(rbind(ChelseaU23_09, ChelseaFirstTeam_09), "C:/Users/peter/Desktop/PlayerData/Chelsea/08-09/AllPlayers_08-09.csv")