...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2008&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_09 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_09$PlayerAppearences[ChelseaFirstTeam_09$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_09$PlayerAppearences <- as.numeric(ChelseaFirstTeam_09$PlayerAppearences)
...
write.csv(ChelseaFirstTeam_09, "C:/Users/peter/Desktop/PlayerData/Chelsea/08-09/FirstTeam_08-09.csv")

write.csv(rbind(ChelseaFirstTeam_09, ChelseaU23_09), "C:/Users/peter/Desktop/PlayerData/Chelsea/08-09/AllPlayers_08-09.csv")