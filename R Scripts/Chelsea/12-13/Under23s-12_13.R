...
page <- "https://www.transfermarkt.com/chelsea-fc-u23/leihspielerhistorie/verein/9250/plus/1?saison_id=2012&leihe=ist"
...
#assiging dataframe
ChelseaU23_13 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaU23_13$PlayerAppearences[ChelseaU23_13$PlayerAppearences == "-"] <- "0"
ChelseaU23_13$PlayerAppearences <- as.numeric(ChelseaU23_13$PlayerAppearences)
...
write.csv(ChelseaU23_13, "C:/Users/peter/Desktop/PlayerData/Chelsea/12-13/Under23s_12-13.csv")

write.csv(rbind(ChelseaU23_13, ChelseaFirstTeam_13), "C:/Users/peter/Desktop/PlayerData/Chelsea/12-13/AllPlayers_12-13.csv")