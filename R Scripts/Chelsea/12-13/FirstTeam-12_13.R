...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2012&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_13 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_13$PlayerAppearences[ChelseaFirstTeam_13$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_13$PlayerAppearences <- as.numeric(ChelseaFirstTeam_13$PlayerAppearences)
ChelseaFirstTeam_13$MarketValue[ChelseaFirstTeam_13$MarketValue == "-"] <- "NA"
ChelseaFirstTeam_13$MarketValue <- as.character(ChelseaFirstTeam_13$MarketValue)

#save to csv

write.csv(ChelseaFirstTeam_13, "C:/Users/peter/Desktop/PlayerData/Chelsea/12-13/FirstTeam_12-13.csv")

write.csv(rbind(ChelseaFirstTeam_13, ChelseaU23_13), "C:/Users/peter/Desktop/PlayerData/Chelsea/12-13/AllPlayers_12-13.csv")