...
page <- "https://www.transfermarkt.com/chelsea-fc-u23/leihspielerhistorie/verein/9250/plus/1?saison_id=2018&leihe=ist"
...
#assiging dataframe
ChelseaU23_19 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaU23_19$PlayerAppearences[ChelseaU23_19$PlayerAppearences == "-"] <- "0"
ChelseaU23_19$PlayerAppearences <- as.numeric(ChelseaU23_19$PlayerAppearences)
ChelseaU23_19$MarketValue[ChelseaU23_19$MarketValue == "-"] <- "0"
ChelseaU23_19$MarketValue <- as.character(ChelseaU23_19$MarketValue)



write.csv(ChelseaU23_19, "C:/Users/peter/Desktop/PlayerData/Chelsea/18-19/Under23s_18-19.csv")

#save to csv
write.csv(rbind(ChelseaFirstTeam_19, ChelseaU23_19), "C:/Users/peter/Desktop/PlayerData/Chelsea/18-19/AllPlayers_18-19.csv")