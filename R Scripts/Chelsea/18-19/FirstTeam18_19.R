...
#assiging dataframe
ChelseaFirstTeam_19 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)
...
#save to csv
write.csv(ChelseaFirstTeam_19, "C:/Users/peter/Desktop/PlayerData/Chelsea/18-19/FirstTeam_18-19.csv")
