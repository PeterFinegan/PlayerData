...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2016&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_17 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_17$PlayerAppearences[ChelseaFirstTeam_17$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_17$PlayerAppearences <- as.numeric(ChelseaFirstTeam_17$PlayerAppearences)
ChelseaFirstTeam_17$MarketValue[ChelseaFirstTeam_17$MarketValue == "-"] <- "0"
ChelseaFirstTeam_17$MarketValue <- as.character(ChelseaFirstTeam_17$MarketValue)

#save to csv

write.csv(ChelseaFirstTeam_17, "C:/Users/peter/Desktop/PlayerData/Chelsea/16-17/FirstTeam_16-17.csv")

write.csv(rbind(ChelseaU23s_17, ChelseaFirstTeam_17), "C:/Users/peter/Desktop/PlayerData/Chelsea/16-17/AllPlayers_16-17.csv")