...
#assiging dataframe
ChelseaU23s_17 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)
...
ChelseaU23s_17$MarketValue[ChelseaU23s_17$MarketValue == "-"] <- "0"
ChelseaU23s_17$MarketValue <- as.character(ChelseaU23s_17$MarketValue)

#save to csv

write.csv(ChelseaU23s_17, "C:/Users/peter/Desktop/PlayerData/Chelsea/16-17/Under23s_16-17.csv")
