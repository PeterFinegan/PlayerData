...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2003&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_04 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_04$PlayerAppearences[ChelseaFirstTeam_04$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_04$PlayerAppearences <- as.numeric(ChelseaFirstTeam_04$PlayerAppearences)
...
write.csv(ChelseaFirstTeam_04, "C:/Users/peter/Desktop/PlayerData/Chelsea/03-04/FirstTeam_03-04.csv")

write.csv(rbind(ChelseaFirstTeam_04), "C:/Users/peter/Desktop/PlayerData/Chelsea/03-04/AllPlayers_03-04.csv")