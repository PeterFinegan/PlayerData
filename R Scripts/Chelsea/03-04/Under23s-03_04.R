...
page <- "https://www.transfermarkt.com/chelsea-fc-u23/leihspielerhistorie/verein/9250/plus/1?saison_id=2003&leihe=ist"
...
#assiging dataframe
ChelseaU23_04 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaU23_04$PlayerAppearences[ChelseaU23_04$PlayerAppearences == "-"] <- "0"
ChelseaU23_04$PlayerAppearences <- as.numeric(ChelseaU23_04$PlayerAppearences)
...
write.csv(ChelseaU23_04, "C:/Users/peter/Desktop/PlayerData/Chelsea/03-04/Under23s_03-04.csv")
write.csv(rbind(ChelseaU23_04, ChelseaFirstTeam_04), "C:/Users/peter/Desktop/PlayerData/Chelsea/03-04/AllPlayers_03-04.csv")