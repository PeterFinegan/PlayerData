...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2007&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_08 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_08$PlayerAppearences[ChelseaFirstTeam_08$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_08$PlayerAppearences <- as.numeric(ChelseaFirstTeam_08$PlayerAppearences)
...
write.csv(ChelseaFirstTeam_08, "C:/Users/peter/Desktop/PlayerData/Chelsea/07-08/FirstTeam_07-08.csv")

write.csv(rbind(ChelseaFirstTeam_08, ChelseaU23_08), "C:/Users/peter/Desktop/PlayerData/Chelsea/07-08/AllPlayers_07-08.csv")