...
#assiging dataframe
ChelseaFirstTeam_14 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)
...
write.csv(ChelseaFirstTeam_14, "C:/Users/peter/Desktop/PlayerData/Chelsea/13-14/FirstTeam_13-14.csv")

write.csv(rbind(ChelseaFirstTeam_14, ChelseaU23_14), "C:/Users/peter/Desktop/PlayerData/Chelsea/13-14/AllPlayers_13-14.csv")