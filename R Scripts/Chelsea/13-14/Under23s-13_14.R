...
page <- "https://www.transfermarkt.com/chelsea-fc-u23/leihspielerhistorie/verein/9250/plus/1?saison_id=2013&leihe=ist"
...
#assiging dataframe
ChelseaU23_14 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)
...
write.csv(ChelseaU23_14, "C:/Users/peter/Desktop/PlayerData/Chelsea/13-14/Under23s_13-14.csv")

write.csv(rbind(ChelseaU23_14, ChelseaFirstTeam_14), "C:/Users/peter/Desktop/PlayerData/Chelsea/13-14/AllPlayers_13-14.csv")