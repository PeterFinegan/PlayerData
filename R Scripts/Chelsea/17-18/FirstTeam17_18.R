...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2017&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_18 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_18$PlayerAppearences[ChelseaFirstTeam_18$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_18$PlayerAppearences <- as.numeric(ChelseaFirstTeam_18$PlayerAppearences)
ChelseaFirstTeam_18$MarketValue[ChelseaFirstTeam_18$MarketValue == "-"] <- "0"
ChelseaFirstTeam_18$MarketValue <- as.character(ChelseaFirstTeam_18$MarketValue)

#save to csv

write.csv(ChelseaFirstTeam_18, "C:/Users/peter/Desktop/PlayerData/Chelsea/17-18/FirstTeam_17-18.csv")

write.csv(rbind(ChelseaFirstTeam_18, ChelseaU23s_18), "C:/Users/peter/Desktop/PlayerData/Chelsea/17-18/All_Player_17-18.csv")