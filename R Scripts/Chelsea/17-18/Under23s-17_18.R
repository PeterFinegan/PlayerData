...
#assiging dataframe
ChelseaU23s_18 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaU23s_18$PlayerAppearences[ChelseaU23s_18$PlayerAppearences == "-"] <- "0"
ChelseaU23s_18$PlayerAppearences <- as.numeric(ChelseaU23s_18$PlayerAppearences)
ChelseaU23s_18$MarketValue[ChelseaU23s_18$MarketValue == "-"] <- "0"
ChelseaU23s_18$MarketValue <- as.character(ChelseaU23s_18$MarketValue)

#save to csv

write.csv(ChelseaU23s_18, "C:/Users/peter/Desktop/PlayerData/Chelsea/17-18/Under23s_17-18.csv")

write.csv(rbind(ChelseaFirstTeam_18, ChelseaU23s_18), "C:/Users/peter/Desktop/PlayerData/Chelsea/17-18/AllPlayers_17-18.csv")