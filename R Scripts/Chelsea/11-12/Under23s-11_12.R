...
page <- "https://www.transfermarkt.com/chelsea-fc-u23/leihspielerhistorie/verein/9250/plus/1?saison_id=2011&leihe=ist"
...
#assiging dataframe
ChelseaU23_12 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaU23_12$PlayerAppearences[ChelseaU23_12$PlayerAppearences == "-"] <- "0"
ChelseaU23_12$PlayerAppearences <- as.numeric(ChelseaU23_12$PlayerAppearences)
...
write.csv(ChelseaU23_12, "C:/Users/peter/Desktop/PlayerData/Chelsea/11-12/Under23s_11-12.csv")

write.csv(rbind(ChelseaU23_12, ChelseaFirstTeam_12), "C:/Users/peter/Desktop/PlayerData/Chelsea/11-12/AllPlayers_11-12.csv")