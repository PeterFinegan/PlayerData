...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2011&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_12 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_12$PlayerAppearences[ChelseaFirstTeam_12$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_12$PlayerAppearences <- as.numeric(ChelseaFirstTeam_12$PlayerAppearences)
ChelseaFirstTeam_12$MarketValue[ChelseaFirstTeam_12$MarketValue == "-"] <- "0"
ChelseaFirstTeam_12$MarketValue <- as.character(ChelseaFirstTeam_12$MarketValue)

#save to csv

write.csv(ChelseaFirstTeam_12, "C:/Users/peter/Desktop/PlayerData/Chelsea/11-12/FirstTeam_11-12.csv")


write.csv(rbind(ChelseaFirstTeam_12, ChelseaU23_12), "C:/Users/peter/Desktop/PlayerData/Chelsea/11-12/AllPlayers_11-12.csv")