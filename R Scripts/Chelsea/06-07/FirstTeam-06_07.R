...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2006&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_07 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_07$PlayerAppearences[ChelseaFirstTeam_07$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_07$PlayerAppearences <- as.numeric(ChelseaFirstTeam_07$PlayerAppearences)
...
write.csv(ChelseaFirstTeam_07, "C:/Users/peter/Desktop/PlayerData/Chelsea/06-07/FirstTeam_06-07.csv")

write.csv(rbind(ChelseaFirstTeam_07, ChelseaU23_07), "C:/Users/peter/Desktop/PlayerData/Chelsea/06-07/AllPlayers_06-07.csv")