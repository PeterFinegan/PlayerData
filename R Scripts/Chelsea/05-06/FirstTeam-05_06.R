...
page <- "https://www.transfermarkt.com/chelsea-fc/leihspielerhistorie/verein/631/plus/1?saison_id=2005&leihe=ist"
...
#assiging dataframe
ChelseaFirstTeam_06 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaFirstTeam_06$PlayerAppearences[ChelseaFirstTeam_06$PlayerAppearences == "-"] <- "0"
ChelseaFirstTeam_06$PlayerAppearences <- as.numeric(ChelseaFirstTeam_06$PlayerAppearences)
...
write.csv(ChelseaFirstTeam_06, "C:/Users/peter/Desktop/PlayerData/Chelsea/05-06/FirstTeam_05-06.csv")

write.csv(rbind(ChelseaFirstTeam_06, ChelseaU23_06), "C:/Users/peter/Desktop/PlayerData/Chelsea/05-06/AllPlayers_05-06.csv")