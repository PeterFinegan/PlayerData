...
page <- "https://www.transfermarkt.com/chelsea-fc-u23/leihspielerhistorie/verein/9250/plus/1?saison_id=2005&leihe=ist"
...
#assiging dataframe
ChelseaU23_06 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ChelseaU23_06$PlayerAppearences[ChelseaU23_06$PlayerAppearences == "-"] <- "0"
ChelseaU23_06$PlayerAppearences <- as.numeric(ChelseaU23_06$PlayerAppearences)
...
write.csv(ChelseaU23_06, "C:/Users/peter/Desktop/PlayerData/Chelsea/05-06/Under23s_05-06.csv")

write.csv(rbind(ChelseaU23_06, ChelseaFirstTeam_06), "C:/Users/peter/Desktop/PlayerData/Chelsea/05-06/AllPlayers_05-06.csv")