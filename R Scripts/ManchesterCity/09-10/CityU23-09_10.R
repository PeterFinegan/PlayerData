...
page <- "https://www.transfermarkt.com/manchester-city-u23/leihspielerhistorie/verein/9265/plus/1?saison_id=2009&leihe=ist"
...
#assiging dataframe
ManCityU23_10 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityU23_10$PlayerAppearences[ManCityU23_10$PlayerAppearences == "-"] <- "0"
ManCityU23_10$PlayerAppearences <- as.numeric(ManCityU23_10$PlayerAppearences)
...
write.csv(ManCityU23_10, "C:/Users/peter/Desktop/PlayerData/Manchester City/10-11/U23_10-11.csv")

write.csv(rbind(ManCityFirstTeam_10, ManCityU23_10), "C:/Users/peter/Desktop/PlayerData/Manchester City/10-11/AllPlayers_10-11.csv")