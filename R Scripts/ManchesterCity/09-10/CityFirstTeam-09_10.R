...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2009&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_10 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_10$PlayerAppearences[ManCityFirstTeam_10$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_10$PlayerAppearences <- as.numeric(ManCityFirstTeam_10$PlayerAppearences)
...
write.csv(ManCityFirstTeam_10, "C:/Users/peter/Desktop/PlayerData/Manchester City/09-10/FirstTeam_09-10.csv")

write.csv(rbind(ManCityFirstTeam_10, ManCityU23_10), "C:/Users/peter/Desktop/PlayerData/Manchester City/09-10/AllPlayers_09-10.csv")