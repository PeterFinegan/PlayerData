...
page <- "https://www.transfermarkt.com/manchester-city-u23/leihspielerhistorie/verein/9265/plus/1?saison_id=2004&leihe=ist"
...
#assiging dataframe
ManCityU23_05 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityU23_05$PlayerAppearences[ManCityU23_05$PlayerAppearences == "-"] <- "0"
ManCityU23_05$PlayerAppearences <- as.numeric(ManCityU23_05$PlayerAppearences)
...
write.csv(ManCityU23_05, "C:/Users/peter/Desktop/PlayerData/Manchester City/04-05/U23_04-05.csv")

write.csv(rbind(ManCityFirstTeam_05, ManCityU23_05), "C:/Users/peter/Desktop/PlayerData/Manchester City/04-05/AllPlayers_04-05.csv")