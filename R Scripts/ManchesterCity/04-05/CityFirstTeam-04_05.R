...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2004&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_05 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_05$PlayerAppearences[ManCityFirstTeam_05$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_05$PlayerAppearences <- as.numeric(ManCityFirstTeam_05$PlayerAppearences)
...
write.csv(ManCityFirstTeam_05, "C:/Users/peter/Desktop/PlayerData/Manchester City/04-05/FirstTeam_04-05.csv")

write.csv(rbind(ManCityFirstTeam_05), "C:/Users/peter/Desktop/PlayerData/Manchester City/04-05/AllPlayers_04-05.csv")