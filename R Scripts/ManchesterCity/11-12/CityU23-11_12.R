...
page <- "https://www.transfermarkt.com/manchester-city-u23/leihspielerhistorie/verein/9265/plus/1?saison_id=2011&leihe=ist"
...
#assiging dataframe
ManCityU23_12 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityU23_12$PlayerAppearences[ManCityU23_12$PlayerAppearences == "-"] <- "0"
ManCityU23_12$PlayerAppearences <- as.numeric(ManCityU23_12$PlayerAppearences)
...
write.csv(ManCityU23_13, "C:/Users/peter/Desktop/PlayerData/Manchester City/11-12/U23_11-12.csv")

write.csv(rbind(ManCityFirstTeam_12, ManCityU23_12), "C:/Users/peter/Desktop/PlayerData/Manchester City/11-12/AllPlayers_11-12.csv")