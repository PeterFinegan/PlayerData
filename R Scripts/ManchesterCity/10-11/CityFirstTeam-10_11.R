...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2010&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_11 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)
...
ManCityFirstTeam_11$PlayerAppearences[ManCityFirstTeam_11$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_11$PlayerAppearences <- as.numeric(ManCityFirstTeam_11$PlayerAppearences)
...
write.csv(ManCityFirstTeam_11, "C:/Users/peter/Desktop/PlayerData/Manchester City/10-11/FirstTeam_10-11.csv")

write.csv(rbind(ManCityFirstTeam_11, ManCityU23_11), "C:/Users/peter/Desktop/PlayerData/Manchester City/10-11/AllPlayers_10-11.csv")