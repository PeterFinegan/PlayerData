...
page <- "https://www.transfermarkt.com/manchester-city-u23/leihspielerhistorie/verein/9265/plus/1?saison_id=2016&leihe=ist"
...
#assiging dataframe
ManCityU23_17 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityU23_17$PlayerAppearences[ManCityU23_17$PlayerAppearences == "-"] <- "0"
ManCityU23_17$PlayerAppearences <- as.numeric(ManCityU23_17$PlayerAppearences)
...
write.csv(ManCityU23_17, "C:/Users/peter/Desktop/PlayerData/Manchester City/16-17/U23_16-17.csv")

write.csv(rbind(ManCityU23_17, ManCityFirstTeam_17), "C:/Users/peter/Desktop/PlayerData/Manchester City/16-17/AllPlayers_16-17.csv")