...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2016&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_17 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_17$PlayerAppearences[ManCityFirstTeam_17$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_17$PlayerAppearences <- as.numeric(ManCityFirstTeam_17$PlayerAppearences)
...
write.csv(ManCityFirstTeam_17, "C:/Users/peter/Desktop/PlayerData/Manchester City/16-17/FirstTeam_16-17.csv")

write.csv(rbind(ManCityFirstTeam_17, ManCityU23_17), "C:/Users/peter/Desktop/PlayerData/Manchester City/16-17/AllPlayers_16-17.csv")