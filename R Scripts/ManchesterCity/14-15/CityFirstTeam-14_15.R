...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2014&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_15 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_15$PlayerAppearences[ManCityFirstTeam_15$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_15$PlayerAppearences <- as.numeric(ManCityFirstTeam_15$PlayerAppearences)
...
write.csv(ManCityFirstTeam_15, "C:/Users/peter/Desktop/PlayerData/Manchester City/14-15/FirstTeam_14-15.csv")

write.csv(rbind(ManCityFirstTeam_15, ManCityU23_15), "C:/Users/peter/Desktop/PlayerData/Manchester City/14-15/AllPlayers_14-15.csv")