...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2017&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_18 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_18$PlayerAppearences[ManCityFirstTeam_18$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_18$PlayerAppearences <- as.numeric(ManCityFirstTeam_18$PlayerAppearences)
...
#save to csv
write.csv(ManCityFirstTeam_18, "C:/Users/peter/Desktop/PlayerData/Manchester City/17-18/FirstTeam_17-18.csv")

write.csv(rbind(ManCityFirstTeam_18, ManCityU23_18), "C:/Users/peter/Desktop/PlayerData/Manchester City/17-18/AllPlayers_17-18.csv")