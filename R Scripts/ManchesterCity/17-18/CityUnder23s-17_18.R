...
page <- "https://www.transfermarkt.com/manchester-city-u23/leihspielerhistorie/verein/9265/plus/1?saison_id=2017&leihe=ist"
...
#assiging dataframe
ManCityU23_18 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityU23_18$PlayerAppearences[ManCityU23_18$PlayerAppearences == "-"] <- "0"
ManCityU23_18$PlayerAppearences <- as.numeric(ManCityU23_18$PlayerAppearences)
...
write.csv(ManCityU23_18, "C:/Users/peter/Desktop/PlayerData/Manchester City/17-18/Under23s_17-18.csv")

write.csv(rbind(ManCityU23_18, ManCityFirstTeam_18), "C:/Users/peter/Desktop/PlayerData/Manchester City/17-18/AllPlayers_17-18.csv")