...
page <- "https://www.transfermarkt.com/manchester-city-u23/leihspielerhistorie/verein/9265/plus/1?saison_id=2007&leihe=ist"
...
#assiging dataframe
ManCityU23_08 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityU23_08$PlayerAppearences[ManCityU23_08$PlayerAppearences == "-"] <- "0"
ManCityU23_08$PlayerAppearences <- as.numeric(ManCityU23_08$PlayerAppearences)
...
write.csv(ManCityU23_08, "C:/Users/peter/Desktop/PlayerData/Manchester City/07-08/U23_07-08.csv")

write.csv(rbind(ManCityFirstTeam_09, ManCityU23_09), "C:/Users/peter/Desktop/PlayerData/Manchester City/07-08/AllPlayers_07-08.csv")