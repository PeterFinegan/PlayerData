...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2007&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_08 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_08$PlayerAppearences[ManCityFirstTeam_08$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_08$PlayerAppearences <- as.numeric(ManCityFirstTeam_08$PlayerAppearences)
...
write.csv(ManCityFirstTeam_08, "C:/Users/peter/Desktop/PlayerData/Manchester City/07-08/FirstTeam_07-08.csv")

write.csv(rbind(ManCityFirstTeam_08, ManCityU23_08), "C:/Users/peter/Desktop/PlayerData/Manchester City/07-08/AllPlayers_07-08.csv")