...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2008&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_09 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_09$PlayerAppearences[ManCityFirstTeam_09$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_09$PlayerAppearences <- as.numeric(ManCityFirstTeam_09$PlayerAppearences)
...
write.csv(ManCityFirstTeam_09, "C:/Users/peter/Desktop/PlayerData/Manchester City/08-09/FirstTeam_08-09.csv")

write.csv(rbind(ManCityFirstTeam_09), "C:/Users/peter/Desktop/PlayerData/Manchester City/08-09/AllPlayers_08-09.csv")