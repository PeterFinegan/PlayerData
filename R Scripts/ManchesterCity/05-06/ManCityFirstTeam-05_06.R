...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2005&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_06 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_06$PlayerAppearences[ManCityFirstTeam_06$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_06$PlayerAppearences <- as.numeric(ManCityFirstTeam_06$PlayerAppearences)
...
write.csv(ManCityFirstTeam_06, "C:/Users/peter/Desktop/PlayerData/Manchester City/05-06/FirstTeam_05-06.csv")

write.csv(rbind(ManCityFirstTeam_06, ManCityU23_06), "C:/Users/peter/Desktop/PlayerData/Manchester City/05-06/AllPlayers_05-06.csv")