...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2006&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_07 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_07$PlayerAppearences[ManCityFirstTeam_07$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_07$PlayerAppearences <- as.numeric(ManCityFirstTeam_07$PlayerAppearences)
