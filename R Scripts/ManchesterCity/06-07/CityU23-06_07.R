...
page <- "https://www.transfermarkt.com/manchester-city-u23/leihspielerhistorie/verein/9265/plus/1?saison_id=2006&leihe=ist"
...
#assiging dataframe
ManCityU23_07 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityU23_07$PlayerAppearences[ManCityU23_07$PlayerAppearences == "-"] <- "0"
ManCityU23_07$PlayerAppearences <- as.numeric(ManCityU23_07$PlayerAppearences)
...
write.csv(ManCityU23_07, "C:/Users/peter/Desktop/PlayerData/Manchester City/06-07/U23_06-07.csv")
