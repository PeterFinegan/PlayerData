...
#assiging dataframe
ManCityFirstTeam_19 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)
...
write.csv(ManCityFirstTeam_19, "C:/Users/peter/Desktop/PlayerData/Manchester City/18-19/FirstTeam_18-19.csv")

write.csv(rbind(ManCityFirstTeam_19, ManCityU23_19), "C:/Users/peter/Desktop/PlayerData/Manchester City/18-19/AllPlayers_18-19.csv")