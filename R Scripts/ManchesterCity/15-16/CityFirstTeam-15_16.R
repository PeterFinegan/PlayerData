...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2015&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_16 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_16$PlayerAppearences[ManCityFirstTeam_16$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_16$PlayerAppearences <- as.numeric(ManCityFirstTeam_16$PlayerAppearences)
...
write.csv(ManCityFirstTeam_16, "C:/Users/peter/Desktop/PlayerData/Manchester City/15-16/FirstTeam_15-16.csv")

write.csv(rbind(ManCityFirstTeam_16, ManCityU23_16), "C:/Users/peter/Desktop/PlayerData/Manchester City/15-16/AllPlayers_16-17.csv")