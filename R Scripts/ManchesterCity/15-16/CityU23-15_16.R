...
page <- "https://www.transfermarkt.com/manchester-city-u23/leihspielerhistorie/verein/9265/plus/1?saison_id=2015&leihe=ist"
...
#assiging dataframe
ManCityU23_16 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityU23_16$PlayerAppearences[ManCityU23_16$PlayerAppearences == "-"] <- "0"
ManCityU23_16$PlayerAppearences <- as.numeric(ManCityU23_16$PlayerAppearences)
...
write.csv(ManCityU23_16, "C:/Users/peter/Desktop/PlayerData/Manchester City/15-16/U23_15-16.csv")

write.csv(rbind(ManCityFirstTeam_16, ManCityU23_16), "C:/Users/peter/Desktop/PlayerData/Manchester City/15-16/AllPlayers_15-16.csv")