...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2013&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_14 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_14$PlayerAppearences[ManCityFirstTeam_14$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_14$PlayerAppearences <- as.numeric(ManCityFirstTeam_14$PlayerAppearences)
...
write.csv(ManCityFirstTeam_14, "C:/Users/peter/Desktop/PlayerData/Manchester City/13-14/FirstTeam_13-14.csv")

write.csv(rbind(ManCityFirstTeam_14, ManCityU23_14), "C:/Users/peter/Desktop/PlayerData/Manchester City/13-14/AllPlayers_13-14.csv")