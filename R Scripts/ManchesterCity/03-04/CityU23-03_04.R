...
page <- "https://www.transfermarkt.com/manchester-city-u23/leihspielerhistorie/verein/9265/plus/1?saison_id=2003&leihe=ist"
...
#assiging dataframe
ManCityU23_04 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityU23_04$PlayerAppearences[ManCityU23_04$PlayerAppearences == "-"] <- "0"
ManCityU23_04$PlayerAppearences <- as.numeric(ManCityU23_04$PlayerAppearences)
...
write.csv(ManCityU23_04, "C:/Users/peter/Desktop/PlayerData/Manchester City/03-04/U23_03-04.csv")

write.csv(rbind(ManCityFirstTeam_04, ManCityU23_04), "C:/Users/peter/Desktop/PlayerData/Manchester City/03-04/AllPlayers_03-04.csv")