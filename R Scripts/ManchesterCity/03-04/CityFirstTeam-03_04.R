...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2003&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_04 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_04$PlayerAppearences[ManCityFirstTeam_04$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_04$PlayerAppearences <- as.numeric(ManCityFirstTeam_04$PlayerAppearences)
...
write.csv(ManCityFirstTeam_04, "C:/Users/peter/Desktop/PlayerData/Manchester City/03-04/FirstTeam_03-04.csv")

write.csv(rbind(ManCityFirstTeam_04), "C:/Users/peter/Desktop/PlayerData/Manchester City/03-04/AllPlayers_03-04.csv")