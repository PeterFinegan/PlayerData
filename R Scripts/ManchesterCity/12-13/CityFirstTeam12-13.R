...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/plus/1?saison_id=2012&leihe=ist"
...
#assiging dataframe
ManCityFirstTeam_13 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_13$PlayerAppearences[ManCityFirstTeam_13$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_13$PlayerAppearences <- as.numeric(ManCityFirstTeam_13$PlayerAppearences)
...
write.csv(ManCityFirstTeam_13, "C:/Users/peter/Desktop/PlayerData/Manchester City/12-13/FirstTeam_12-13.csv")

write.csv(rbind(ManCityFirstTeam_13, ManCityU23_12), "C:/Users/peter/Desktop/PlayerData/Manchester City/12-13/AllPlayers_12-13.csv")