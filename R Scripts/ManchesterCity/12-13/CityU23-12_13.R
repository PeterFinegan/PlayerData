...
page <- "https://www.transfermarkt.com/manchester-city-u23/leihspielerhistorie/verein/9265/plus/1?saison_id=2012&leihe=ist"
...
#assiging dataframe
ManCityU23_13 <- data.frame(LoanStart, LoanEnd, PlayerNames, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, club, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityU23_13$PlayerAppearences[ManCityU23_13$PlayerAppearences == "-"] <- "0"
ManCityU23_13$PlayerAppearences <- as.numeric(ManCityU23_13$PlayerAppearences)
...
write.csv(ManCityU23_13, "C:/Users/peter/Desktop/PlayerData/Manchester City/12-13/U23_12-13.csv")

write.csv(rbind(ManCityFirstTeam_13, ManCityU23_13), "C:/Users/peter/Desktop/PlayerData/Manchester City/12-13/AllPlayers_12-13.csv")