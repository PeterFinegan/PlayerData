...
page <- "https://www.transfermarkt.com/manchester-city/leihspielerhistorie/verein/281/saison_id/2018/leihe/ist/plus/1"
...
#assiging dataframe
ManCityFirstTeam_19 <- data.frame(LoanStart, LoanEnd, PlayerNamesChels, Age, PlayerLoanClub, clubCountry, PlayerAppearences, MarketValue, MarketFluctuation, stringsAsFactors=FALSE)

#converts the "-" sign to a 0
#https://stackoverflow.com/questions/53787049/converting-to-a-0-in-r
ManCityFirstTeam_19$PlayerAppearences[ManCityFirstTeam_19$PlayerAppearences == "-"] <- "0"
ManCityFirstTeam_19$PlayerAppearences <- as.numeric(ManCityFirstTeam_19$PlayerAppearences)
...
write.csv(ManCityFirstTeam_19, "C:/Users/peter/Desktop/PlayerData/ManchesterCity/18-19/FirstTeam_18-19.csv")

write.csv(rbind(ManCityFirstTeam_19), "C:/Users/peter/Desktop/PlayerData/ManchesterCity/AllCityPlayers.csv")
write.csv(rbind(ChelseaFirstTeam_19), "C:/Users/peter/Desktop/PlayerData/ManchesterCity/18-19/AllPlayers_18-19.csv")