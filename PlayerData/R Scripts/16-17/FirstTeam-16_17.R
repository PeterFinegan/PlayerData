...
#assiging dataframe
ChelseaFirstTeam_17 <- data.frame(LoanStart, LoanEnd, PlayerNamesChels, Age, PlayerLoanClub, clubCountry, PlayerAppearences, stringsAsFactors=FALSE)
...
write.csv(rbind(ChelseaFirstTeam_17, ChelseaFirstTeam_18, ChelseaFirstTeam_19, ChelseaU23_19, ChelseaU23s_18, ChelseaU23s_17), "C:/Users/peter/Desktop/PlayerData/AllPlayers.csv")
