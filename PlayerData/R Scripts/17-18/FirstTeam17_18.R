...
#assiging dataframe
ChelseaFirstTeam_18 <- data.frame(LoanStart, LoanEnd, PlayerNamesChels, Age, PlayerLoanClub, clubCountry, PlayerAppearences, stringsAsFactors=FALSE)
...
write.csv(rbind(ChelseaFirstTeam_18), "C:/Users/peter/Desktop/PlayerData/17-18/All_Player_17-18.csv")