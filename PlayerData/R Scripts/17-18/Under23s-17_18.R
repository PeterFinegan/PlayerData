...
#assiging dataframe
ChelseaU23s_18 <- data.frame(LoanStart, LoanEnd, PlayerNamesChels, Age, PlayerLoanClub, clubCountry, PlayerAppearences, stringsAsFactors=FALSE)
...
write.csv(ChelseaU23s_18, "C:/Users/peter/Desktop/PlayerData/17-18/Under23s_17-18.csv")

write.csv(rbind(ChelseaFirstTeam_18, ChelseaFirstTeam_19, ChelseaU23_19, ChelseaU23s_18), "C:/Users/peter/Desktop/PlayerData/AllPlayers.csv")
write.csv(rbind(ChelseaFirstTeam_18, ChelseaU23s_18), "C:/Users/peter/Desktop/PlayerData/17-18/AllPlayers_17-18.csv")